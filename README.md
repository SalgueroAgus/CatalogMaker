...
Cada catálogo se guarda localmente en el navegador y dispositivo que estás usando. Iniciar sesión
...
Editá con los campos etiquetados de **Artículos** y usá **Cambiar foto**, **Subir** y **Bajar**.
La flecha **Volver arriba** lleva al comienzo de Artículos o Vista Previa.
En **Páginas** podés elegir una cantidad general y, en cada página,
...
En **Menú del catálogo → Administración del catálogo** hay tres acciones con confirmación:
...
## Mis catálogos y respaldos

La app abre el último catálogo usado. Su nombre aparece en la cabecera: pulsalo para abrir
**Mis catálogos**. Allí podés abrir, renombrar, hacer una copia completa o crear un catálogo vacío
con el diseño inicial de la app. El nombre del catálogo no cambia la marca impresa en sus páginas.
**Principal** se identifica con una insignia y no se puede eliminar ni reemplazar. La publicación
web está disponible solamente desde Principal; cualquier catálogo con productos permite descargar PDF.

Al eliminar otro catálogo pasa a **Eliminados**, donde conserva productos, fotos y diseño hasta
que lo recuperes o confirmes su borrado definitivo. Las copias y Eliminados comparten el
almacenamiento de este navegador: no son un respaldo externo. Vaciar productos o restablecer
ajustes todavía no tiene recuperación automática.

Usá **Descargar respaldo del actual** para obtener un archivo `.catalogmaker.json` con productos,
fotos originales y diseño editable. Buscalo en Descargas o en la ubicación que elegiste. Para
llevarlo a otro dispositivo, transferí ese archivo y elegí **Restaurar respaldo** en la app del
destino: revisá nombre/cantidad y confirmá. Siempre se crea un catálogo nuevo, sin sobrescribir
los existentes. El respaldo también permite rescatar el borrador de una sesión cuyo guardado falló.
El PDF sirve para compartir, y la plantilla Excel para agregar productos; ninguno reemplaza este respaldo.

Si otra pestaña modificó el mismo catálogo, la app detiene las escrituras y permite **Cargar versión
guardada** o **Conservar mis cambios como copia**. Cambiar de catálogo espera a que termine el
guardado; si hay un precio inválido o un error, corregilo o reintentá antes de cambiar.
