...
function captureState(): SessionSnapshot {
  ...
  const { storeName, footerContact, colors, fonts, fontSizes, bgImage, bgImageOpacity, itemsPerPage, pageLayouts } = useSettingsStore.getState();
  ...
  return {
    ...
    data: {
      ...
      settings: { storeName, footerContact, colors, fonts, fontSizes, bgImageOpacity, itemsPerPage, pageLayouts },
      images,
